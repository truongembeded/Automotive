/* CAN cell init */
    ...
    CAN_InitStructure.CAN_SJW = CAN_SJW_1tq;//Khoảng thời gian tối đa mà tín hiệu truyền dữ liệu được phép trễ so với tín hiệu đồng bộ hóa trong chu kỳ truyền dữ liệu
    ...
    CAN_FilterInitStructure.CAN_FilterIdHigh = 0x0000;// khởi tạo ban đầu cho nó vì truyền nó không liên quan đến, khi nhận mới cần set up cho nó
